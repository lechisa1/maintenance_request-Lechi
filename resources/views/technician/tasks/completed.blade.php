                        ...
                        @forelse($requests as $key => $request)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <span
                                            class="badge bg-{{ $request->maintenanceRequest->user_feedback === 'accepted' ? 'success' : 'secondary' }}">
                                            @if ($request->maintenanceRequest->user_feedback === 'pending')
                                                <h5>No Feedback yet</h5>
                                            @else
                                                {{ ucfirst($request->maintenanceRequest->user_feedback ?? 'Waiting') }}
                                            @endif
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td colspan="8">
                                    <div class="row g-2 p-3 text-start" style="list-style: none;">
                                        ...
                                        <div class="col-12 border-bottom py-1"><strong>Requested At:</strong>
                                            {{ $request->maintenanceRequest->requested_at->format('M d, Y h:i A') }}</div>
                                        ...
                                        <div class="col-12 border-bottom py-1"><strong>Completed At:</strong>
                                            {{ $request->maintenanceRequest->completed_at->format('M d, Y h:i A') }}
                                        </div>
                                    </div>
                                </td>
                            </tr>
