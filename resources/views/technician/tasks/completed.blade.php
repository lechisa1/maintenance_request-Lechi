                                ...
                                @forelse($requests as $key => $request)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            @elseif ($request->maintenanceRequest->user_feedback === 'accepted')
                                                <span class="badge bg-success">Accepted</span>
                                            @elseif ($request->maintenanceRequest->user_feedback === 'rejected')
                                                <span class="badge bg-danger">Rejected</span>
                                            @elseif ($request->maintenanceRequest->user_feedback === 'pending')
