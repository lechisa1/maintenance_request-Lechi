    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4">
                <div class="card-header bg-gradient-primary bg-opacity-10 border-bottom d-flex justify-content-between align-items-center py-3">
                    <div>
                    ...
                    <div>
                        <span class="badge rounded-pill bg-{{ $request->priority == 'high' ? 'danger' : ($request->priority == 'medium' ? 'warning' : 'success') }} py-2 px-3">
                            <i class="fas fa-{{ $request->priority == 'high' ? 'exclamation-triangle' : ($request->priority == 'medium' ? 'exclamation-circle' : 'check-circle') }} me-1"></i>
                            {{ ucfirst($request->priority) }} Priority
                        </span>
                        <span class="badge rounded-pill bg-{{ $request->status == 'completed' ? 'success' : ($request->status == 'in_progress' ? 'info' : 'warning') }} py-2 px-3 ms-2">
                            <i class="fas fa-{{ $request->status == 'completed' ? 'check-circle' : ($request->status == 'in_progress' ? 'spinner fa-spin' : 'clock') }} me-1"></i>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-5 fw-semibold">{{ $request->item ? $request->item->name : 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-danger rounded-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><strong>Rejection Reason:</strong> {{ $request->rejection_reason }}</p>
                            </div>
                        </div>
                    </div>
                    @endif
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('tecknician_work_form', $request->id) }}" class="btn btn-primary rounded-pill px-4 py-2 shadow-sm">
                        ...
                        <div class="timeline-item mb-4">
                            ...
                            <div class="timeline-content">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <small class="text-muted">{{ $request->latestAssignment->assigned_at->format('M j, Y g:i A') }}</small>
                                </div>
                                <p class="text-muted small mb-0">
                                    Assigned by {{ $request->latestAssignment->director->name }} to {{ $request->latestAssignment->technician->name }}
                                </p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <small class="text-muted">{{ $request->completed_at->format('M j, Y g:i A') }}</small>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-5 fw-semibold">{{ $request->latestAssignment->technician->name }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-5 fw-semibold">{{ $request->latestAssignment->director->name }}</p>
                                </div>
                            </div>
                        </div>
    ...
    document.querySelectorAll('.preview-btn').forEach(button => {
        button.addEventListener('click', function (e) {
            ...
            if (supportedTypes.includes(fileType)) {
                ...
                alert('Preview not supported for this file type. Please download it instead.');
            }
        });
    });
});
