...
@section('content')
    <div class="container py-5">
        <div class="card shadow-lg border-0 rounded-4 bg-white">
            <div class="card-body px-4 py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-primary fw-bold mb-0">In Progress Maintenance Request List</h3>
                ...
                <div class="table-responsive rounded-3 shadow-sm">
                    <table class="table table-hover align-middle mb-0" id="requestsTable">
                        ...
                        <tbody>
                            @forelse($inProgressRequest as $key => $request)
                                    ...
                                    <td colspan="8">
                                        <div class="row g-2 p-3 text-start" style="list-style: none;">
                                            ...
                                            @if ($request->latestAssignment)
                                                <div class="col-12 py-1"><strong>Assigned To:</strong>
                                                    {{ $request->latestAssignment->technician->name }}</div>
                                            @endif
                                            @if ($request->latestAssignment)
                                                <div class="col-12 py-1"><strong>Assigned At:</strong>
        ...
        @include('components.pagination', ['paginator' => $inProgressRequest])
    </div>
