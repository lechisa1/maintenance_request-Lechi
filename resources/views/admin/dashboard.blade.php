...
@section('content')
    ...
    <!-- Page Content -->
    <div class="container-fluid px-4 card shadow-2xl bg-white mt-5">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col me-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Total Sectors</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalSector }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="bi bi-diagram fs-2 text-gray-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-left-success h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="bi bi-diagram-2 fs-2 text-gray-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    <div class="container mt-5">
        ...
        <h4 class="text-center">Users per Departments</h4>
        <div class="m-5">
