    ...
    <div class="px-3 pt-3">
        ...
        <div class="mb-4">
            ...
            <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="usersMenu">
                            <ul class="nav flex-column ps-3">
                                <li class="nav-item">
                                <li class="nav-item">
                                    <a href="{{ route('users_index') }}" class="nav-link  bi bi-list fs-6">
                                        User Lists</a>
                                </li>
                                @if (auth()->user()->can('add_new_user'))
                                    <li class="nav-item">
                                        <a href="{{ route('create_users') }}"
                                            class="nav-link  bi bi-plus fs-6">
                                            Add Users</a>
                                    </li>
                                @endif
                ...
                @if (auth()->user()->can('add_new_division') ||
                        auth()->user()->can('edit_division') ||
                        auth()->user()->can('delete_division'))
                    <li class="nav-item">
                            ...
                            <ul class="nav flex-column ps-3">
                                <li class="nav-item">
                                    <a href="{{ route('organization.index') }}"
                                        class="nav-link bi bi-list  fs-6">Organization Unit
                                        Lists</a>
                                </li>
                                <li class="nav-item">
                                ...
                                @if (auth()->user()->can('view_user_roles'))
                                    <li class="nav-item">
                                        <a href="{{ route('roles_with_permission') }}"
                                            class="nav-link bi bi-list  fs-6">Roles
                                        </a>
                                    </li>
                                @endif
                ...
                @endif
                {{-- here Added for Label management --}}
                <li class="nav-item">
                    <a href="{{ route('labels.index') }}" class="nav-link" title="Manage Labels">
