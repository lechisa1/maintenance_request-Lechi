...
{
    $users = User::with('reportsTo')->latest()->paginate(10);
   ...
   $totalUsers=User::count();
    ...
    public function create()
    {
        ...
        $departments = Department::all();
        return view('usermanagement.create', compact('departments', 'roles','users','job_positions'));
    }
 ...
 // ensure roles are selected
    ...
    public function edit(User $user)
    {
        ...
        return view('usermanagement.edit', compact('user', 'departments','roles','users','job_positions'));
    }
